...
public class Fase4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Variable name: " + name.toString());
		System.out.println("Variable surname: " + surname.toString());
		System.out.println("Variable fullName: " + fullName.toString());
	}
}
